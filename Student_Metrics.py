...
st.set_page_config(page_title='Institution GU Student Dashboard',layout='wide')

st.title('Institution GU - Student Dashboard')
...
df_test_scores = pd.read_csv('./student-data/institution-gu-test-data.csv',parse_dates=['test_date'])
